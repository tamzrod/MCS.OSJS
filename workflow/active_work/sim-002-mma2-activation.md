...
**4 / 10 — Medium.** One structural activation transaction. If repository inspection reveals composition and lifecycle control are independently unresolved, split before execution.
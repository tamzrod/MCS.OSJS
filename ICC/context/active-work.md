...
SIM-001…SIM-008 are complete+verified. SIM-010 completed at `0b356da`. SIM-011 — Remove Simulator MMA2 Lifecycle Ownership — **COMPLETED 2026-09-08** at pushed commit `82d6ac6`: child-process lifecycle code/tests were deleted; boot and structural paths compose only; Simulator stop cannot stop MMA2; runtime-router schedulers remain unarmed pending SIM-015. SIM-012 — Local Simulator Configuration Path — is now CURRENT. SIM-010…SIM-017 remain human-promoted for sequential execution in dependency order (see handoff.md).

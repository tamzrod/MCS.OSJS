...
ACTIVE — SIM-013 current. SIM-010 through SIM-017 are human-promoted for sequential execution.
...
4. `workflow/active_work/sim-013-compose-shared-mma2-config.md` — SIM-013: safely compose Simulator-owned entries into shared MMA2 config. **CURRENT**.

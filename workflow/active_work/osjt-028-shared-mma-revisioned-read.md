# OSJT-028 — Shared MMA revisioned read
...
## Primary outcome
Implement mma-load with whitelisted root settings and exact-config-byte revision under the existing shared lock; read only.
...
Depends on OSJT-027; target/permissions derive from OSJT-001.

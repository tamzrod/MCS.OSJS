# OSJT-025 — Advanced editor persistence wiring
...
## Primary outcome
Mount the shared editor using Memory mma2 and Replicator mma2_advanced; save/discard/duplicate preserve fields and failures retain drafts.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/memory-editor.js; OSJS/src/packages/MCSModbusToolkit/replicator-editor.js; OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-advanced-persistence.test.js
...
Depends on OSJT-024; target/permissions derive from OSJT-001.

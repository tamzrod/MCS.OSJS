# OSJT-050 — Linux diagnostics port evidence
...
## Primary outcome
Report configured listeners and locally observable ownership only; container/network-namespace limitations must be explicit; no privileged Docker socket or host access.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/diagnostics-backend.js; OSJS/tests/toolkit-diagnostics-ports.test.js
...
Depends on OSJT-049; target/permissions derive from OSJT-001.

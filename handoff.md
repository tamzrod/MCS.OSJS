...
ACTIVE — SIM-015 current. SIM-010 through SIM-017 are human-promoted for sequential execution.
...
6. `workflow/active_work/sim-015-run-simulation-after-mma2-apply.md` — SIM-015: run schedulesand Raw Ingest after successful MMA2 apply/readiness. **CURRENT**.

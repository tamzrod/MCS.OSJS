...
## Primary outcome
Add Device Definition and Advanced Settings folder tabs to both editors, preserving device drafts; no settings controls yet.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/memory-editor.js; OSJS/src/packages/MCSModbusToolkit/replicator-editor.js; OSJS/src/packages/MCSModbusToolkit/renderer.css; OSJS/tests/toolkit-advanced-tabs.test.js
...
Depends on OSJT-012; target/permissions derive from OSJT-001.

...
## Primary outcome
Add ordered access rules and Read Only, Write Only, Read/Write, Custom modes; show function checkboxes only for Custom.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-access-modes.test.js
...
Depends on OSJT-014; target/permissions derive from OSJT-001.

# OSJT-030 — Shared MMA candidate validation
...
## Primary outcome
Build a pure root-settings candidate: omission preserves, null removes, unknown keys reject, memories and owners remain unchanged; use whole-config validation and keep unsafe outputs disabled.

## Bounded scope
simulator/shared_settings.go; simulator/osjs_toolkit_settings_test.go
...
Depends on OSJT-029; target/permissions derive from OSJT-001.

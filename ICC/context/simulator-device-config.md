# Simulator Device Config + MMA2 Compose/Ownership + Scheduler + Raw Ingest + SaveDocument + Loopback Bridge + Managed MMA2 Lifecycle + Ready-Gated Routing (SIM-001 → SIM-009)

...
## Primary outcome
Edit per-area RBE rule name/start/count; keep configured output status truthful and do not enable a shared listener.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-rbe-rules.test.js
...
Depends on OSJT-020; target/permissions derive from OSJT-001.

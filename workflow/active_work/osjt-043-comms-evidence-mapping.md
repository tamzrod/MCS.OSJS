# OSJT-043 — COMMS evidence mapping
...
## Primary outcome
Map real per-block layer evidence with device/block correlation, timestamp freshness and ERROR/WARNING/UNKNOWN/OK precedence; no inferred green.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/replicator-adapter.js; OSJS/tests/toolkit-comms-evidence.test.js
...
Depends on OSJT-042; target/permissions derive from OSJT-001.

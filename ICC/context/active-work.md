...
SIM-001…SIM-008 are complete+verified. SIM-010 through SIM-013 are complete( SIM-013 at `24fd5b1` guaranteed enabled-only transactional composition with authoritative validation(. SIM-014 — MMA2 RESTART-only Control — **COMPLETED 2026-09-08** at pushed commit `db2276c`: restart request + ready wait + truthful failure surfacing, live reload verified. SIM-015 — Run Simulation after MMA2 Apply — **COMPLETED 2026-09-08** at pushed commit `3652b98`: ApplyRouter arms enabled schedules only after the full Save & Apply chain success; ArmSchedules replaces prior schedules; disabled devices never arm; restart failure arms nothing. SIM-016 — Restore Enabled Simulations on Boot — is now CURRENT. SIM-010…SIM-017 remain human-promotedin dependency order.

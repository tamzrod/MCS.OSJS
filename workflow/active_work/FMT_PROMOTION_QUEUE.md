...
| --- | --- | --- | --- |
| FMT-001 | fmt-001-toolkit-source-reconciliation.md | NONE | COMPLETE |
| FMT-002 | fmt-002-electron-ui-inventory.md | NONE | COMPLETE |
| FMT-003 | fmt-003-osjs-toolkit-ui-inventory.md | NONE | COMPLETE |
| FMT-004 | fmt-004-backend-boundary-inventory.md | NONE | COMPLETE |
| FMT-005 | fmt-005-build-baseline.md | FMT-001, FMT-003 | BLOCKED (awaiting explicit build command/authorization) |
| FMT-006 | fmt-006-ui-gap-map.md | FMT-001, FMT-002, FMT-003 | ACTIVE (blockers resolved) |
| FMT-007 | fmt-007-backend-gap-map.md | FMT-001, FMT-004 | COMPLETE (evidence verified) |

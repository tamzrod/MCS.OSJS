# OSJT-045 — COMMS LED presentation
...
## Primary outcome
Wire evidence into four LEDs with timestamps/errors in tooltips, pulse only on new success, clear stale evidence and honor reduced motion.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/replicator-editor.js; OSJS/src/packages/MCSModbusToolkit/renderer.css; OSJS/tests/toolkit-comms-leds.test.js
...
Depends on OSJT-044; target/permissions derive from OSJT-001.

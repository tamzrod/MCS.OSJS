...
## Primary outcome
Add a separate shared draft dialog reachable from either Advanced Settings editor; Close retains draft, Discard restores it, Save sends revision and conflict asks for reload; no automatic output enabling.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/shared-editor.js; OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-shared-dialog.test.js
...
Depends on OSJT-039; target/permissions derive from OSJT-001.

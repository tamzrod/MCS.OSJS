# OSJT-038 — Toolkit shared settings relay
...
## Primary outcome
Expose namespaced mma-load and capability-gated mma-apply through the existing framed Unix service; carry revisions and typed errors, bounded payload and correlated replies.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/server.js; OSJS/src/packages/MCSModbusToolkit/memory-contract.js; OSJS/tests/toolkit-mma-relay.test.js
...
Depends on OSJT-037; target/permissions derive from OSJT-001.

# OSJT-023 — RBE global ID allocation
...
## Primary outcome
Allocate IDs across loaded Memory and Replicator devices and remap duplicated rules; exhaustion rejects duplication without modifying originals; backend remains final collision authority.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/advanced-ids.js; OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-rbe-ids.test.js
...
Depends on OSJT-022; target/permissions derive from OSJT-001.

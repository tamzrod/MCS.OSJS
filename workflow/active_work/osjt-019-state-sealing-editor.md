...
## Primary outcome
Add sealing enable, control coil address and exception selector; default off; validate the control address against the destination coil range.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/advanced-editor.js; OSJS/tests/toolkit-state-sealing.test.js
...
Depends on OSJT-018; target/permissions derive from OSJT-001.

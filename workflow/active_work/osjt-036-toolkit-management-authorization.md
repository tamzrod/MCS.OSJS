# OSJT-036 — Toolkit management authorization
...
## Primary outcome
Define a server-owned manage-MMA capability based on authenticated OS.js session/group information; deny when unavailable; never trust a browser-provided identity.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/mma-authorization.js; OSJS/src/packages/MCSModbusToolkit/server.js; OSJS/tests/toolkit-mma-authorization.test.js
...
Depends on OSJT-035; target/permissions derive from OSJT-001.

# OSJT-052 — Linux diagnostics log evidence
...
## Primary outcome
Read only explicitly approved service log files with bounded tails and missing-file/permission errors; never accept arbitrary browser paths or enable host Docker access.

## Bounded scope
OSJS/src/packages/MCSModbusToolkit/diagnostics-backend.js; OSJS/tests/toolkit-diagnostics-logs.test.js
...
Depends on OSJT-051; target/permissions derive from OSJT-001.
